...
__all__ = ["GatedCNNBlock_BCHW", "mambaout_base", "mambaout_femto", "mambaout_kobe", "mambaout_small", "mambaout_tiny"]
...
default_cfgs = {
    "mambaout_femto": _cfg(url="https://github.com/yuweihao/MambaOut/releases/download/model/mambaout_femto.pth"),
    "mambaout_kobe": _cfg(url="https://github.com/yuweihao/MambaOut/releases/download/model/mambaout_kobe.pth"),
    "mambaout_tiny": _cfg(url="https://github.com/yuweihao/MambaOut/releases/download/model/mambaout_tiny.pth"),
    "mambaout_small": _cfg(url="https://github.com/yuweihao/MambaOut/releases/download/model/mambaout_small.pth"),
    "mambaout_base": _cfg(url="https://github.com/yuweihao/MambaOut/releases/download/model/mambaout_base.pth"),
}
