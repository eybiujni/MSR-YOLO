...
class LightningModel(pl.LightningModule):
    ...
    def shared_step(self, batch, step):
        ...
        content_loss, style_loss, identity_loss1, identity_loss2 = self.loss(
            Ics, output_Icc, output_Iss, content, style
        )

        self.log(r"id_loss1", identity_loss1.item(), prog_bar=step == "train_model")
        self.log(r"id_loss2", identity_loss2.item(), prog_bar=step == "train_model")

        # Log metrics
        self.log(r"loss_style", style_loss.item(), prog_bar=step == "train_model")
        self.log(r"loss_content", content_loss.item(), prog_bar=step == "train_model")
    ...
    def on_validation_epoch_end(self):
        ...
        with torch.no_grad():
            ...
            logger.add_image(r"val_img", grid, global_step=self.global_step + 1)
            self.validation_step_outputs = []
    ...
    def loss(self, Ics, output_Icc, output_Iss, content, style):
        ...
        return (
            ...
            self.lambda1 * id1_loss,
            self.lambda2 * id2_loss,
        )
