...
class TensorBoardImageLogger(TensorBoardLogger):
    """Wrapper for TensorBoardLogger which logs images to disk, instead of the TensorBoard log file.
    """
...
def parse_args():
    ...
    # train_model setting
    parser.add_argument("--gpus", nargs="+", default="0", help="GPU for training. Command usage sample: --gpus 0 1")
    parser.add_argument("--iterations", type=int, default=200_000, help="The number of training iterations.")
    parser.add_argument("--log-dir", type=str, default="./", help="The directory where the logs are saved to.")
    parser.add_argument("--checkpoint", type=str, default=None, help="Resume training from a checkpoint file.")
    parser.add_argument(
        "--val-interval",
        type=int,
        default=1000,
    ...
    parser.add_argument(
        "--content", type=str, default="/home/liuhd/dataset_ST/train2017", help="Directory with content images."
    )
    parser.add_argument(
        "--style", type=str, default="/home/liuhd/dataset_ST/train", help="Directory with style images."
    )
    # test data during training
    parser.add_argument(
        "--test-content",
        type=str,
        default="./test_images/content",
        help="Directory with test content images. If not set, takes 5 random train_model content images.",
    )
    parser.add_argument(
        "--test-style",
        type=str,
        default="./test_images/style",
